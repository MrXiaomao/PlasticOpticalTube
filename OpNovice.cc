...
int main(int argc,char** argv)
{
  ...
  for ( G4int i=1; i<argc; i=i+2 ) {
     ...
     else if ( G4String(argv[i]) == "L" ) water_length = atof(argv[i+1])*cm;
 ...
 // nThreads=4;
  ...
  runManager-> SetUserInitialization(new OpNoviceDetectorConstruction(water_length));
  // Physics list
